# -*- coding: utf-8 -*-
"""
Created on Sun Aug 20 21:43:58 2023
...
class FastLeFF(nn.Module):
    """
    Initializes an instance of the FastLeFF module.

    Args:
    - dim (int): The input and output dimension of the module.
    - hidden_dim (int): The dimension of the intermediate hidden features.
    - act_layer (nn.Module, optional): Activation function layer applied after linear and depthwise convolution layers.
                                       Default is nn.GELU.
    - drop (float, optional): Dropout rate applied after the first linear layer. Default is 0.0 (no dropout).
    """
...
def conv(in_channels, out_channels, kernel_size, bias=False, stride = 1):
    """
    Creates a 2D convolutional layer with specified parameters.
    
    Args:
    - in_channels (int): Number of input channels for the convolutional layer.
    - out_channels (int): Number of output channels (i.e., filters) produced by the convolutional layer.
    - kernel_size (int): Size of the square convolution kernel.
    - bias (bool, optional): Whether to include a bias term in the convolution operation. Default is False.
    - stride (int, optional): Stride value for the convolution. Default is 1.
    
    Returns:
    - nn.Conv2d: A PyTorch 2D convolutional layer instance with the specified configuration.
    """
    return nn.Conv2d(
