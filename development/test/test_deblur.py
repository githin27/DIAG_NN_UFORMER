# -*- coding: utf-8 -*-
"""
Created on Tue Aug 22 12:17:11 2023
...
if __name__ == '__main__':
    opt = options.Options().init(argparse.ArgumentParser(description='Image deblruing')).parse_args()
...
#------------------------------------------------------------------------------
    # Loading data
    print('\nLoading datasets...')
    test_dataset = get_validation_deblur_data(opt.test_dir)
